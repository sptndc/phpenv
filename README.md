...
This will get you going with the latest version of phpenv without
needing a systemwide install.
...
3. Set up phpenv in your shell.
   ...
   Follow the printed instructions to [set up phpenv shell integration](#how-phpenv-hooks-into-your-shell).

4. Restart your shell so that PATH changes take effect. (Opening a
   new terminal tab will usually do it.)
...
If you've installed phpenv manually using Git, you can upgrade to the
...
4. Installs the sh dispatcher. This bit is also optional, but allows
   ...
   doesn't do anything invasive like override `cd` or hack your shell
